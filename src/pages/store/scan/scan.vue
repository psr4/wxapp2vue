<template>
    <page>
        <div class="header">      <img :src="store.img"></img>      <div class="tip">{{store.title}}</div>  </div>   <div class='bor20'></div>  <form @submit="submit">      <div class="form">          <div class="row">              <img src='/image/img/huiyuan.png'></img>              <div class="label">                  会员名              </div>              <div class="content">                  <div class="input">                      <input type="text" name="username" :value="customer.username" />                  </div>              </div>              <div class="tip">                  <button @click.stop="scan">扫码</button>              </div>          </div>          <div class='bor20'></div>          <div class="row">              <img src='/image/img/jine.png'></img>              <div class="label">                  支付金额              </div>              <div class="content">                  <div class="input">                      <input type="text" name="price" />                  </div>              </div>                        </div>          <div class="note">当前可提现金额：{{customer.money}}</div>          <div class='bor20'></div>          <div class="row">              <div class="btn">                  <button type="submit">提交保存</button>              </div>          </div>      </div>  </form>
    </page>
</template>
<script>
